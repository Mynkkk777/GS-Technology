...
//            self.placeholderLabel.frame = CGRect(x: 0, y: 0, width: self.placeholderLabel.frame.width - 2, height: self.placeholderLabel.frame.height - 5)
...
//        placeholderLabel.font.withSize(placeholderLabel.font.pointSize - 5.0)
        layoutPlaceholderInTextRect()
